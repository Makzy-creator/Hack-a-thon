...
export const GreeterContractInteractions: FC = () => {
  ...
  return (
    <>
      <div className="flex max-w-[22rem] grow flex-col gap-4 text-[#6b21a8]">
        <h2 className="text-center font-mono text-[#6b21a8]">Greeter Smart Contract</h2>
        ...
        <Form {...form}>
          ...
          <Card>
            <CardContent className="pt-6">
              <FormItem>
                <FormLabel className="text-base text-[#6b21a8]">Fetched Greeting</FormLabel>
                <FormControl>
                  <Input
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              >
                <FormItem>
                  <FormLabel className="text-base text-[#6b21a8]">Update Greeting</FormLabel>
                  <FormControl>
                    <div className="flex gap-2">
                      <Input disabled={form.formState.isSubmitting} {...register('newMessage')} />
                      <Button
                        type="submit"
                        className="bg-[#6b21a8] font-bold"
        ...
        {/* Contract Address */}
        <p className="text-center font-mono text-xs text-[#6b21a8]">
