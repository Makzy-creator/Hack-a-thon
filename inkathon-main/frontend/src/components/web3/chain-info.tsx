...
export const ChainInfo: FC = () => {
  ...
  if (!api)
    return (
      <div className="mb-4 mt-8 flex flex-col items-center justify-center space-y-3 text-center font-mono text-sm text-primary/90 sm:flex-row sm:space-x-3 sm:space-y-0">
        <Spinner />
        <div>
  ...
  return (
    <>
      <div className="flex max-w-[22rem] grow flex-col gap-4">
        <h2 className="text-center font-mono text-[#6b21a8]">Chain Info</h2>

        <Card>
          <CardContent className="pb-3 pt-6 text-[#6b21a8]">
            {/* Metadata */}
          ...
          <CardFooter className="flex items-center justify-center space-x-3">
            ...
            {!!activeChain?.explorerUrls && !!Object.keys(activeChain.explorerUrls)?.length && (
              <Link
                ...
                target="_blank"
                className="flex items-center justify-center gap-1 text-center text-sm text-[#6b21a8] hover:text-primary/90"
              >
